  ...
  <section>
    ...
    <Card className="about">
      ...
      Qui sommes-nous
        ...
        <Typography>
        La santé, la formation du caractère, la débrouillardise et l'esprit de service sont les quatre buts vers lesquels nous orientons toute l’approche éducative de notre association.
        </Typography>
      </CardContent>
    </Card>
